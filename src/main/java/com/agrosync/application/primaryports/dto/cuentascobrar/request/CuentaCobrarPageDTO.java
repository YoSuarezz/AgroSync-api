...
public class CuentaCobrarPageDTO {
    ...
    public CuentaCobrarPageDTO(int page, int size, String sortBy, String sortDirection, ObtenerCuentaCobrarDTO obtenerCuentaCobrar, EstadoCuentaEnum estado, UUID suscripcionId) {
        setPage(page);
        setSize(size);
        setSortBy(sortBy);
