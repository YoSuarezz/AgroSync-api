...
public final class EntityAgroSyncException extends AgroSyncException {

    private static final long serialVersionUID = 1L;
    private static final Layer layer = Layer.ENTITY;

    public EntityAgroSyncException(final String mensajeUsuario) {
        super(mensajeUsuario, layer);
    }

    public EntityAgroSyncException(final String mensajeTecnico, final String mensajeUsuario) {
