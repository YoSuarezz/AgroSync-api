...
public final class DTOAgroSyncException extends AgroSyncException {

    private static final long serialVersionUID = 1L;
    private static final Layer layer = Layer.DTO;

    public DTOAgroSyncException(final String mensajeUsuario) {
        super(mensajeUsuario, layer);
    }

    public DTOAgroSyncException(final String mensajeTecnico, final String mensajeUsuario) {
