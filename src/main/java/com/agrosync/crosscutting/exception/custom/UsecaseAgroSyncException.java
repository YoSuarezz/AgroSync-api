...
public final class UsecaseAgroSyncException extends AgroSyncException {

    private static final long serialVersionUID = 1L;
    private static final Layer layer = Layer.USECASE;

    public UsecaseAgroSyncException(final String mensajeUsuario) {
        super(mensajeUsuario, layer);
    }

    public UsecaseAgroSyncException(final String mensajeTecnico, final String mensajeUsuario) {
